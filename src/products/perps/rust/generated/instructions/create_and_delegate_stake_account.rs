...
pub struct CreateAndDelegateStakeAccount {
    ...
    pub validator_vote_account: solana_address::Address,

    pub stake_config: solana_address::Address,

    pub wsol_mint: solana_address::Address,

    pub temp_wsol_account: solana_address::Address,
    ...
    pub stake_program: solana_address::Address,
...
impl CreateAndDelegateStakeAccount {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateAndDelegateStakeAccountInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl CreateAndDelegateStakeAccountInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct CreateAndDelegateStakeAccountBuilder {
    ...
    validator_vote_account: Option<solana_address::Address>,
    stake_config: Option<solana_address::Address>,
    wsol_mint: Option<solana_address::Address>,
    temp_wsol_account: Option<solana_address::Address>,
    rent: Option<solana_address::Address>,
    clock: Option<solana_address::Address>,
    stake_history: Option<solana_address::Address>,
    stake_program: Option<solana_address::Address>,
...
impl CreateAndDelegateStakeAccountBuilder {
    ...
    pub fn validator_vote_account(
        &mut self,
        validator_vote_account: solana_address::Address,
    ) -> &mut Self {
        self.validator_vote_account = Some(validator_vote_account);
        self
    }
    #[inline(always)]
    pub fn stake_config(&mut self, stake_config: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn temp_wsol_account(&mut self, temp_wsol_account: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn stake_program(&mut self, stake_program: solana_address::Address) -> &mut Self {
...
pub struct CreateAndDelegateStakeAccountCpiAccounts<'a, 'b> {
    ...
    pub validator_vote_account: &'b solana_account_info::AccountInfo<'a>,

    pub stake_config: &'b solana_account_info::AccountInfo<'a>,

    pub wsol_mint: &'b solana_account_info::AccountInfo<'a>,

    pub temp_wsol_account: &'b solana_account_info::AccountInfo<'a>,
...
impl<'a, 'b> CreateAndDelegateStakeAccountCpiBuilder<'a, 'b> {
    ...
    pub fn validator_vote_account(
        &mut self,
        validator_vote_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn stake_config(
        &mut self,
        stake_config: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn temp_wsol_account(
        &mut self,
        temp_wsol_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct CreateAndDelegateStakeAccountCpiBuilderInstruction<'a, 'b> {
    ...
    validator_vote_account: Option<&'b solana_account_info::AccountInfo<'a>>,
    stake_config: Option<&'b solana_account_info::AccountInfo<'a>>,
