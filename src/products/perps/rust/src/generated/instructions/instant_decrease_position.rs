...
pub struct InstantDecreasePosition {
    ...
    pub api_keeper: solana_address::Address,

    pub owner: solana_address::Address,

    pub receiving_account: solana_address::Address,
    ...
    pub desired_mint: solana_address::Address,

    pub referral: Option<solana_address::Address>,
...
impl InstantDecreasePosition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InstantDecreasePositionInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InstantDecreasePositionInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct InstantDecreasePositionBuilder {
    ...
    api_keeper: Option<solana_address::Address>,
    owner: Option<solana_address::Address>,
    receiving_account: Option<solana_address::Address>,
    ...
    desired_mint: Option<solana_address::Address>,
    referral: Option<solana_address::Address>,
...
impl InstantDecreasePositionBuilder {
    ...
    #[inline(always)]
    pub fn api_keeper(&mut self, api_keeper: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn receiving_account(&mut self, receiving_account: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn desired_mint(&mut self, desired_mint: solana_address::Address) -> &mut Self {
        self.desired_mint = Some(desired_mint);
        self
    }
    /// `[optional account]`
    #[inline(always)]
    pub fn referral(&mut self, referral: Option<solana_address::Address>) -> &mut Self {
...
pub struct InstantDecreasePositionCpiAccounts<'a, 'b> {
    ...
    pub api_keeper: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub desired_mint: &'b solana_account_info::AccountInfo<'a>,
...
impl<'a, 'b> InstantDecreasePositionCpiBuilder<'a, 'b> {
    ...
    pub fn api_keeper(
        &mut self,
        api_keeper: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn receiving_account(
        &mut self,
        receiving_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn desired_mint(
        &mut self,
        desired_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct InstantDecreasePositionCpiBuilderInstruction<'a, 'b> {
    ...
    api_keeper: Option<&'b solana_account_info::AccountInfo<'a>>,
    ...
    desired_mint: Option<&'b solana_account_info::AccountInfo<'a>>,
    referral: Option<&'b solana_account_info::AccountInfo<'a>>,
