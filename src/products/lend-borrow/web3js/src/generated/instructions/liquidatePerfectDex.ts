...
import {
    ...
    liquidatePerfectDexDebtAmountsCodec,
...
export interface LiquidatePerfectDexInstructionArgs {
    debtAmt: bigint;
    debtPerfectAmounts: LiquidatePerfectDexDebtAmounts | null;
...
const LiquidatePerfectDexInstructionDataCodec = getStructCodec([
    ['debtAmt', getU64Codec()],
    ['debtPerfectAmounts', getOptionCodec(liquidatePerfectDexDebtAmountsCodec)],
...
export function createLiquidatePerfectDexInstruction(
    ...
    const instructionData = Buffer.from(LiquidatePerfectDexInstructionDataCodec.encode(args));
