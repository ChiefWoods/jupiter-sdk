...
const TurnOnSmartDebtInstructionDataCodec = getStructCodec([['token0Amt', getU64Codec()]]);
...
export function createTurnOnSmartDebtInstruction(
    ...
    const instructionData = Buffer.from(TurnOnSmartDebtInstructionDataCodec.encode(args));
