...
export const CREATE_DECREASE_POSITION_REQUEST2_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([105, 64, 201, 82, 250, 14, 109, 77]);

export function getCreateDecreasePositionRequest2DiscriminatorBytes(): ReadonlyUint8Array {
