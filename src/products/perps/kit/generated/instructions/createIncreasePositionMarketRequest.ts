...
export const CREATE_INCREASE_POSITION_MARKET_REQUEST_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([184, 85, 199, 24, 105, 171, 156, 56]);

export function getCreateIncreasePositionMarketRequestDiscriminatorBytes(): ReadonlyUint8Array {
