...
export const SHARED_ACCOUNTS_ROUTE_V2_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([209, 152, 83, 147, 124, 254, 216, 233]);

export function getSharedAccountsRouteV2DiscriminatorBytes(): ReadonlyUint8Array {
...
> {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta("sourceTokenProgram", accounts.sourceTokenProgram),
      getAccountMeta(
        "destinationTokenProgram",
        accounts.destinationTokenProgram,
      ),
