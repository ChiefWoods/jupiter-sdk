...
export type VaultArgs = {
  ...
  tokenAccount: Address;
  tokenProgram: Address;
  stalesnessThreshold: number | bigint;
  minOraclePriceUsd: number | bigint;
  maxOraclePriceUsd: number | bigint;
  status: VaultStatusArgs;
  padding1: ReadonlyUint8Array;
  bump: number;
  decimals: number;
  padding2: ReadonlyUint8Array;
  oracles: Array<OracleTypeArgs>;
  padding3: ReadonlyUint8Array;
...
export function getVaultEncoder(): FixedSizeEncoder<VaultArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["stalesnessThreshold", getU64Encoder()],
      ["minOraclePriceUsd", getU64Encoder()],
      ["maxOraclePriceUsd", getU64Encoder()],
      ["status", getVaultStatusEncoder()],
      ["padding1", fixEncoderSize(getBytesEncoder(), 7)],
      ["bump", getU8Encoder()],
      ["decimals", getU8Encoder()],
      ["padding2", fixEncoderSize(getBytesEncoder(), 6)],
      ["oracles", getArrayEncoder(getOracleTypeEncoder(), { size: 5 })],
