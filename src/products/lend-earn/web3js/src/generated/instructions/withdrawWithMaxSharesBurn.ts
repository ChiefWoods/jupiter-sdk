...
const WithdrawWithMaxSharesBurnInstructionDataCodec = getStructCodec([
    ['amount', getU64Codec()],
    ['maxSharesBurn', getU64Codec()],
]);
...
export function createWithdrawWithMaxSharesBurnInstruction(
    ...
    const instructionData = Buffer.from(WithdrawWithMaxSharesBurnInstructionDataCodec.encode(args));
