...
pub enum AggregatorV6Error {
    ...
    BondingCurveAlreadyCompleted = 0x178A,
}

impl From<AggregatorV6Error> for solana_program_error::ProgramError {
    fn from(e: AggregatorV6Error) -> Self {
