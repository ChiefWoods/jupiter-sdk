...
import { OperatePerfectDexColAmounts, operatePerfectDexColAmountsCodec } from '../types/operatePerfectDexColAmounts';
import { OperatePerfectDexDebtAmounts, operatePerfectDexDebtAmountsCodec } from '../types/operatePerfectDexDebtAmounts';
import { TransferType, transferTypeCodec } from '../types/transferType';
import { VAULTS_PROGRAM_ID } from '..';
import { addCodecSizePrefix, getBytesCodec, getOptionCodec, getStructCodec, getU32Codec } from '@solana/codecs';
...
export interface OperatePerfectDexInstructionArgs {
    colAmounts: OperatePerfectDexColAmounts | null;
    debtAmounts: OperatePerfectDexDebtAmounts | null;
    transferType: TransferType | null;
    remainingAccountsIndices: Uint8Array;
}

const OperatePerfectDexInstructionDataCodec = getStructCodec([
    ['colAmounts', getOptionCodec(operatePerfectDexColAmountsCodec)],
    ['debtAmounts', getOptionCodec(operatePerfectDexDebtAmountsCodec)],
...
export function createOperatePerfectDexInstruction(
    ...
    const instructionData = Buffer.from(OperatePerfectDexInstructionDataCodec.encode(args));
