...
const PaybackPerfectInstructionDataCodec = getStructCodec([
    ['shares', getU64Codec()],
...
export function createPaybackPerfectInstruction(
    ...
    const instructionData = Buffer.from(PaybackPerfectInstructionDataCodec.encode(args));
    const discriminator = Buffer.from('2702c5660bba6101', 'hex');
