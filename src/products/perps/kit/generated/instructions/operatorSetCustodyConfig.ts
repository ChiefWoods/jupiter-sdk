...
export const OPERATOR_SET_CUSTODY_CONFIG_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([166, 137, 92, 204, 145, 224, 24, 218]);

export function getOperatorSetCustodyConfigDiscriminatorBytes(): ReadonlyUint8Array {
