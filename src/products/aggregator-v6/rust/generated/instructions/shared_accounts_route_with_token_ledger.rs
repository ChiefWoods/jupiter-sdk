...
pub struct SharedAccountsRouteWithTokenLedger {
    ...
    pub user_transfer_authority: solana_address::Address,

    pub source_token_account: solana_address::Address,

    pub program_source_token_account: solana_address::Address,

    pub program_destination_token_account: solana_address::Address,

    pub destination_token_account: solana_address::Address,

    pub source_mint: solana_address::Address,

    pub destination_mint: solana_address::Address,

    pub platform_fee_account: Option<solana_address::Address>,

    pub token2022_program: Option<solana_address::Address>,
...
pub struct SharedAccountsRouteWithTokenLedgerBuilder {
    ...
    user_transfer_authority: Option<solana_address::Address>,
    source_token_account: Option<solana_address::Address>,
    program_source_token_account: Option<solana_address::Address>,
    program_destination_token_account: Option<solana_address::Address>,
    destination_token_account: Option<solana_address::Address>,
    source_mint: Option<solana_address::Address>,
    destination_mint: Option<solana_address::Address>,
    platform_fee_account: Option<solana_address::Address>,
...
impl SharedAccountsRouteWithTokenLedgerBuilder {
    ...
    pub fn user_transfer_authority(
        &mut self,
        user_transfer_authority: solana_address::Address,
    ) -> &mut Self {
    ...
    pub fn program_source_token_account(
        &mut self,
        program_source_token_account: solana_address::Address,
    ) -> &mut Self {
    ...
    pub fn program_destination_token_account(
        &mut self,
        program_destination_token_account: solana_address::Address,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn source_mint(&mut self, source_mint: solana_address::Address) -> &mut Self {
        self.source_mint = Some(source_mint);
        self
    }
    #[inline(always)]
    pub fn destination_mint(&mut self, destination_mint: solana_address::Address) -> &mut Self {
