...
const PaybackPerfectInOneTokenInstructionDataCodec = getStructCodec([
    ['shares', getU64Codec()],
...
export function createPaybackPerfectInOneTokenInstruction(
    ...
    const instructionData = Buffer.from(PaybackPerfectInOneTokenInstructionDataCodec.encode(args));
