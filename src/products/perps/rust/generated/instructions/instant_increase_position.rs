...
pub struct InstantIncreasePosition {
    ...
    pub funding_account: solana_address::Address,
    ...
    pub token_ledger: Option<solana_address::Address>,
...
impl InstantIncreasePosition {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InstantIncreasePositionInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InstantIncreasePositionInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct InstantIncreasePositionBuilder {
    ...
    funding_account: Option<solana_address::Address>,
    ...
    token_ledger: Option<solana_address::Address>,
...
impl InstantIncreasePositionBuilder {
    ...
    #[inline(always)]
    pub fn funding_account(&mut self, funding_account: solana_address::Address) -> &mut Self {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn token_ledger(&mut self, token_ledger: Option<solana_address::Address>) -> &mut Self {
...
pub struct InstantIncreasePositionCpiAccounts<'a, 'b> {
    ...
    pub token_ledger: Option<&'b solana_account_info::AccountInfo<'a>>,
...
impl<'a, 'b> InstantIncreasePositionCpiBuilder<'a, 'b> {
    ...
    pub fn funding_account(
        &mut self,
        funding_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
