...
const WithdrawPerfectInOneTokenInstructionDataCodec = getStructCodec([
    ['shares', getU64Codec()],
    ['minToken0', getU64Codec()],
    ['minToken1', getU64Codec()],
]);
...
export function createWithdrawPerfectInOneTokenInstruction(
    ...
    const instructionData = Buffer.from(WithdrawPerfectInOneTokenInstructionDataCodec.encode(args));
