...
const BorrowInstructionDataCodec = getStructCodec([
    ['token0Amt', getU64Codec()],
    ['token1Amt', getU64Codec()],
    ['maxShares', getU64Codec()],
]);
...
export function createBorrowInstruction(
    ...
    const instructionData = Buffer.from(BorrowInstructionDataCodec.encode(args));
