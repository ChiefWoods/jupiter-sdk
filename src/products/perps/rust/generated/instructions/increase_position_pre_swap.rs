...
pub struct IncreasePositionPreSwap {
    ...
    pub keeper_ata: solana_address::Address,
...
impl IncreasePositionPreSwap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.keeper_ata, false));
        ...
        let data = IncreasePositionPreSwapInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct IncreasePositionPreSwapBuilder {
    ...
    keeper_ata: Option<solana_address::Address>,
...
impl IncreasePositionPreSwapBuilder {
    ...
    #[inline(always)]
    pub fn keeper_ata(&mut self, keeper_ata: solana_address::Address) -> &mut Self {
...
pub struct IncreasePositionPreSwapCpiAccounts<'a, 'b> {
    ...
    pub keeper_ata: &'b solana_account_info::AccountInfo<'a>,
...
impl<'a, 'b> IncreasePositionPreSwapCpiBuilder<'a, 'b> {
    ...
    pub fn keeper_ata(
        &mut self,
        keeper_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct IncreasePositionPreSwapCpiBuilderInstruction<'a, 'b> {
    ...
    keeper_ata: Option<&'b solana_account_info::AccountInfo<'a>>,
