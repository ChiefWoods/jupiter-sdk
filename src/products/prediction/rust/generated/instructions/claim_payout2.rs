...
pub const CLAIM_PAYOUT2_DISCRIMINATOR: [u8; 8] = [141, 205, 99, 203, 142, 231, 87, 226];

/// Accounts.
#[derive(Debug)]
pub struct ClaimPayout2 {
...
pub struct ClaimPayout2InstructionData {
    discriminator: [u8; 8],
}

impl ClaimPayout2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [141, 205, 99, 203, 142, 231, 87, 226],
        }
    }
...
impl Default for ClaimPayout2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ClaimPayout2`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct ClaimPayout2Builder {
...
/// `claim_payout2` CPI accounts.
pub struct ClaimPayout2CpiAccounts<'a, 'b> {
...
/// `claim_payout2` CPI instruction.
pub struct ClaimPayout2Cpi<'a, 'b> {
...
impl<'a, 'b> ClaimPayout2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ClaimPayout2CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClaimPayout2` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   6. `[]` token_program
#[derive(Clone, Debug)]
pub struct ClaimPayout2CpiBuilder<'a, 'b> {
    instruction: Box<ClaimPayout2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimPayout2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClaimPayout2CpiBuilderInstruction {
            __program: program,
            authority: None,
            vault: None,
            position: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ClaimPayout2Cpi {
...
#[derive(Clone, Debug)]
struct ClaimPayout2CpiBuilderInstruction<'a, 'b> {
