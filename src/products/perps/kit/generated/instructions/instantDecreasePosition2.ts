...
export const INSTANT_DECREASE_POSITION2_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([162, 191, 200, 62, 139, 62, 176, 17]);

export function getInstantDecreasePosition2DiscriminatorBytes(): ReadonlyUint8Array {
