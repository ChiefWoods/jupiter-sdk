...
import { getArrayCodec, getStructCodec, getU16Codec } from '@solana/codecs';
...
const InitOracleConfigInstructionDataCodec = getStructCodec([
...
export async function createInitOracleConfigInstruction(
    ...
    const instructionData = Buffer.from(InitOracleConfigInstructionDataCodec.encode(args));
