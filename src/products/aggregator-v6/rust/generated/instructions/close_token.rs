...
pub struct CloseToken {
    ...
    pub program_token_account: solana_address::Address,
...
pub struct CloseTokenBuilder {
    ...
    program_token_account: Option<solana_address::Address>,
...
impl CloseTokenBuilder {
    ...
    pub fn program_token_account(
        &mut self,
        program_token_account: solana_address::Address,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = CloseToken {
            operator: self.operator.unwrap_or(solana_address::address!(
                "9RAufBfjGQjDfrwxeyKmZWPADHSb8HcoqCdrmpqvCr1g"
            )),
            wallet: self.wallet.unwrap_or(solana_address::address!(
