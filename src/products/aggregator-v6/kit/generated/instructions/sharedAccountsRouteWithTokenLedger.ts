...
export const SHARED_ACCOUNTS_ROUTE_WITH_TOKEN_LEDGER_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([230, 121, 143, 80, 119, 159, 106, 170]);

export function getSharedAccountsRouteWithTokenLedgerDiscriminatorBytes(): ReadonlyUint8Array {
