...
export const TOKEN_LEDGER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  156, 247, 9, 188, 54, 108, 85, 77,
]);

export function getTokenLedgerDiscriminatorBytes(): ReadonlyUint8Array {
