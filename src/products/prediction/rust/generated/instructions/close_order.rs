...
pub const CLOSE_ORDER_DISCRIMINATOR: [u8; 8] = [90, 103, 209, 28, 7, 63, 168, 4];
...
pub struct CloseOrderInstructionData {
    discriminator: [u8; 8],
}

impl CloseOrderInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for CloseOrderInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `CloseOrder`.
///
/// ### Accounts:
///
///   0. `[]` owner
...
/// `close_order` CPI accounts.
pub struct CloseOrderCpiAccounts<'a, 'b> {
...
/// `close_order` CPI instruction.
pub struct CloseOrderCpi<'a, 'b> {
...
impl<'a, 'b> CloseOrderCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: CloseOrderCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CloseOrder` via CPI.
///
/// ### Accounts:
///
///   0. `[]` owner
...
#[derive(Clone, Debug)]
pub struct CloseOrderCpiBuilder<'a, 'b> {
    instruction: Box<CloseOrderCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CloseOrderCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CloseOrderCpiBuilderInstruction {
            __program: program,
            owner: None,
            authority: None,
            vault: None,
...
#[derive(Clone, Debug)]
struct CloseOrderCpiBuilderInstruction<'a, 'b> {
