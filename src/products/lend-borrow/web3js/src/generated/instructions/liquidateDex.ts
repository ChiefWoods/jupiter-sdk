...
import { LiquidateDexColAmounts, liquidateDexColAmountsCodec } from '../types/liquidateDexColAmounts';
import { LiquidateDexDebtAmounts, liquidateDexDebtAmountsCodec } from '../types/liquidateDexDebtAmounts';
...
export interface LiquidateDexInstructionArgs {
    debtAmt: bigint;
    debtAmounts: LiquidateDexDebtAmounts | null;
    colPerUnitDebt: bigint;
    colAmounts: LiquidateDexColAmounts | null;
    absorb: boolean;
    transferType: TransferType | null;
    remainingAccountsIndices: Uint8Array;
}

const LiquidateDexInstructionDataCodec = getStructCodec([
    ['debtAmt', getU64Codec()],
    ['debtAmounts', getOptionCodec(liquidateDexDebtAmountsCodec)],
    ['colPerUnitDebt', getU128Codec()],
    ['colAmounts', getOptionCodec(liquidateDexColAmountsCodec)],
...
export function createLiquidateDexInstruction(
    ...
    const instructionData = Buffer.from(LiquidateDexInstructionDataCodec.encode(args));
    const discriminator = Buffer.from('1c81fd7df3340ba2', 'hex');
