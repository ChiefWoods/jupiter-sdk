...
export type PerpetualsPlugin = {
  ...
  identifyAccount: typeof identifyPerpetualsAccount;
  identifyInstruction: typeof identifyPerpetualsInstruction;
  parseInstruction: typeof parsePerpetualsInstruction;
};
...
export function perpetualsProgram() {
  return <T extends PerpetualsPluginRequirements>(
    client: T,
  ): ExtendedClient<T, { perpetuals: PerpetualsPlugin }> => {
    return extendClient(client, {
      perpetuals: <PerpetualsPlugin>{
        ...
        identifyAccount: identifyPerpetualsAccount,
        identifyInstruction: identifyPerpetualsInstruction,
        parseInstruction: parsePerpetualsInstruction,
      },
    });
  };
}
