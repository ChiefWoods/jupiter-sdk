...
export const INSTANT_CREATE_LIMIT_ORDER_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([194, 37, 195, 123, 40, 127, 126, 156]);

export function getInstantCreateLimitOrderDiscriminatorBytes(): ReadonlyUint8Array {
