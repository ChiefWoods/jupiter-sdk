...
export type EventAssetFilter =
  ...
  | {
      ...
      fields: readonly [EventFirstVerifiedCreatorFilter];
    }
  | {
      __kind: "CollectionWithAttribute";
      fields: readonly [EventCollectionWithAttributeFilter];
    };
...
export type EventAssetFilterArgs =
  ...
  | {
      __kind: "FirstVerifiedCreator";
      fields: readonly [EventFirstVerifiedCreatorFilterArgs];
    }
  | {
      __kind: "CollectionWithAttribute";
      fields: readonly [EventCollectionWithAttributeFilterArgs];
    };
...
export function getEventAssetFilterEncoder(): Encoder<EventAssetFilterArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "Collection",
      getStructEncoder([
        ["fields", getTupleEncoder([getEventCollectionFilterEncoder()])],
      ]),
    ],
    [
      ...
      getStructEncoder([
        [
          "fields",
          getTupleEncoder([getEventFirstVerifiedCreatorFilterEncoder()]),
        ],
      ]),
    ],
    [
      ...
      getStructEncoder([
        [
          "fields",
          getTupleEncoder([getEventCollectionWithAttributeFilterEncoder()]),
        ],
      ]),
    ],
  ]);
...
export function getEventAssetFilterDecoder(): Decoder<EventAssetFilter> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "Collection",
      getStructDecoder([
        ["fields", getTupleDecoder([getEventCollectionFilterDecoder()])],
      ]),
    ],
    [
      "FirstVerifiedCreator",
      getStructDecoder([
        [
          "fields",
          getTupleDecoder([getEventFirstVerifiedCreatorFilterDecoder()]),
        ],
      ]),
    ],
    [
      ...
      getStructDecoder([
        [
          "fields",
          getTupleDecoder([getEventCollectionWithAttributeFilterDecoder()]),
        ],
      ]),
    ],
  ]);
...
export function getEventAssetFilterCodec(): Codec<
  EventAssetFilterArgs,
  EventAssetFilter
> {
  return combineCodec(
...
export function eventAssetFilter(
  kind: "None",
): GetDiscriminatedUnionVariant<EventAssetFilterArgs, "__kind", "None">;
export function eventAssetFilter(
  kind: "Collection",
...
>;
export function eventAssetFilter<
  K extends EventAssetFilterArgs["__kind"],
  Data,
>(kind: K, data?: Data) {
