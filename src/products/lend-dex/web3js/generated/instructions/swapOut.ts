...
import { getBooleanEncoder, getStructEncoder, getU64Encoder, type Encoder } from '@solana/codecs';
...
export function createSwapOutInstruction(
    ...
    const instructionData = Buffer.from(getSwapOutInstructionDataEncoder().encode(args));
    const discriminator = Buffer.from('ce24950ea3849401', 'hex');
