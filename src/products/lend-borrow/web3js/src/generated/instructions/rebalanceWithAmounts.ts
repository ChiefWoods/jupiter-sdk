...
import { getOptionCodec, getStructCodec, getU128Codec } from '@solana/codecs';
...
const RebalanceWithAmountsInstructionDataCodec = getStructCodec([
...
export function createRebalanceWithAmountsInstruction(
    ...
    const instructionData = Buffer.from(RebalanceWithAmountsInstructionDataCodec.encode(args));
