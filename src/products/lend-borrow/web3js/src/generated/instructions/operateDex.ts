...
import { OperateDexColAmounts, operateDexColAmountsCodec } from '../types/operateDexColAmounts';
import { OperateDexDebtAmounts, operateDexDebtAmountsCodec } from '../types/operateDexDebtAmounts';
...
export interface OperateDexInstructionArgs {
    colAmounts: OperateDexColAmounts | null;
    debtAmounts: OperateDexDebtAmounts | null;
    transferType: TransferType | null;
    remainingAccountsIndices: Uint8Array;
}

const OperateDexInstructionDataCodec = getStructCodec([
    ['colAmounts', getOptionCodec(operateDexColAmountsCodec)],
    ['debtAmounts', getOptionCodec(operateDexDebtAmountsCodec)],
...
export function createOperateDexInstruction(
    ...
    const instructionData = Buffer.from(OperateDexInstructionDataCodec.encode(args));
    const discriminator = Buffer.from('df7adfb585847421', 'hex');
