...
import { getOperateDexColAmountsEncoder, type OperateDexColAmountsArgs } from '../types/operateDexColAmounts';
import { getOperateDexDebtAmountsEncoder, type OperateDexDebtAmountsArgs } from '../types/operateDexDebtAmounts';
...
export function createOperateDexInstruction(
    ...
    const instructionData = Buffer.from(getOperateDexInstructionDataEncoder().encode(args));
