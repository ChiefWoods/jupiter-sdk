...
pub struct ClosePositionRequest3 {
    pub keeper: Option<solana_address::Address>,

    pub owner: solana_address::Address,

    pub owner_ata: solana_address::Address,
...
impl ClosePositionRequest3 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.owner_ata, false));
        ...
        let data = ClosePositionRequest3InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct ClosePositionRequest3Builder {
    ...
    owner_ata: Option<solana_address::Address>,
...
impl ClosePositionRequest3Builder {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn keeper(&mut self, keeper: Option<solana_address::Address>) -> &mut Self {
        self.keeper = keeper;
        self
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn owner_ata(&mut self, owner_ata: solana_address::Address) -> &mut Self {
