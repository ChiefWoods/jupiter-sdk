...
export type EventAssetArgs =
  ...
  | {
      __kind: "ProgrammableNft";
      fields: readonly [EventProgrammableNftAssetArgs];
    }
...
export function getEventAssetEncoder(): Encoder<EventAssetArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      "Token",
      getStructEncoder([
        ["fields", getTupleEncoder([getEventTokenAssetEncoder()])],
      ]),
    ],
    [
      "ClassicNft",
      getStructEncoder([
        ["fields", getTupleEncoder([getEventClassicNftAssetEncoder()])],
      ]),
    ],
    [
      "ProgrammableNft",
      getStructEncoder([
        ["fields", getTupleEncoder([getEventProgrammableNftAssetEncoder()])],
      ]),
    ],
    [
      "CoreNft",
      getStructEncoder([
        ["fields", getTupleEncoder([getEventCoreNftAssetEncoder()])],
      ]),
    ],
  ]);
}
...
export function getEventAssetDecoder(): Decoder<EventAsset> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      "Token",
      getStructDecoder([
        ["fields", getTupleDecoder([getEventTokenAssetDecoder()])],
      ]),
    ],
    [
      "ClassicNft",
      getStructDecoder([
        ["fields", getTupleDecoder([getEventClassicNftAssetDecoder()])],
      ]),
    ],
    [
      "ProgrammableNft",
      getStructDecoder([
        ["fields", getTupleDecoder([getEventProgrammableNftAssetDecoder()])],
      ]),
    ],
    [
      "CoreNft",
      getStructDecoder([
        ["fields", getTupleDecoder([getEventCoreNftAssetDecoder()])],
      ]),
    ],
  ]);
}
...
export function eventAsset(
  kind: "None",
): GetDiscriminatedUnionVariant<EventAssetArgs, "__kind", "None">;
export function eventAsset(
  kind: "Token",
...
export function eventAsset<K extends EventAssetArgs["__kind"], Data>(
  kind: K,
  data?: Data,
) {
