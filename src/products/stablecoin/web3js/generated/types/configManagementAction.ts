...
export function getConfigManagementActionEncoder(): Encoder<ConfigManagementActionArgs> {
    return getDiscriminatedUnionEncoder([
        ...
        ['UpdatePauseFlag', getStructEncoder([['isMintRedeemEnabled', getBooleanEncoder()]])],
        [
            'UpdatePeriodLimit',
            getStructEncoder([
                ['index', getU8Encoder()],
...
export function getConfigManagementActionDecoder(): Decoder<ConfigManagementAction> {
    return getDiscriminatedUnionDecoder([
        ...
        ['UpdatePauseFlag', getStructDecoder([['isMintRedeemEnabled', getBooleanDecoder()]])],
        [
            'UpdatePeriodLimit',
            getStructDecoder([
                ['index', getU8Decoder()],
...
export function getConfigManagementActionCodec(): Codec<ConfigManagementActionArgs, ConfigManagementAction> {
    return combineCodec(getConfigManagementActionEncoder(), getConfigManagementActionDecoder());
}
...
export function configManagementAction(
    ...
    data: GetDiscriminatedUnionVariantContent<ConfigManagementActionArgs, '__kind', 'UpdatePauseFlag'>,
): GetDiscriminatedUnionVariant<ConfigManagementActionArgs, '__kind', 'UpdatePauseFlag'>;
export function configManagementAction(
    kind: 'UpdatePeriodLimit',
    data: GetDiscriminatedUnionVariantContent<ConfigManagementActionArgs, '__kind', 'UpdatePeriodLimit'>,
): GetDiscriminatedUnionVariant<ConfigManagementActionArgs, '__kind', 'UpdatePeriodLimit'>;
export function configManagementAction(
    kind: 'ResetPeriodLimit',
    data: GetDiscriminatedUnionVariantContent<ConfigManagementActionArgs, '__kind', 'ResetPeriodLimit'>,
): GetDiscriminatedUnionVariant<ConfigManagementActionArgs, '__kind', 'ResetPeriodLimit'>;
export function configManagementAction(
    kind: 'SetPegPriceUSD',
    data: GetDiscriminatedUnionVariantContent<ConfigManagementActionArgs, '__kind', 'SetPegPriceUSD'>,
): GetDiscriminatedUnionVariant<ConfigManagementActionArgs, '__kind', 'SetPegPriceUSD'>;
export function configManagementAction<K extends ConfigManagementActionArgs['__kind'], Data>(kind: K, data?: Data) {
