...
export type InitializeTokenInstruction<
  ...
  TAccountInvite extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      TAccountSender extends string
        ...
        : TAccountSender,
      TAccountInvite extends string
        ? WritableSignerAccount<TAccountInvite> &
            AccountSignerMeta<TAccountInvite>
        : TAccountInvite,
...
export type InitializeTokenInput<
  ...
  TAccountInvite extends string = string,
...
> = {
  ...
  invite: TransactionSigner<TAccountInvite>;
  ...
  expiry: InitializeTokenInstructionDataArgs["expiry"];
  amount: InitializeTokenInstructionDataArgs["amount"];
};
...
> {
  ...
  const originalAccounts = {
    ...
    invite: { value: input.invite ?? null, isWritable: true },
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta("invite", accounts.invite),
