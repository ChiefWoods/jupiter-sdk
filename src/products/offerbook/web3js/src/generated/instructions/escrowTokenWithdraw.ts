...
const EscrowTokenWithdrawInstructionDataCodec = getStructCodec([['amount', getU64Codec()]]);
...
export async function createEscrowTokenWithdrawInstruction(
    ...
    const instructionData = Buffer.from(EscrowTokenWithdrawInstructionDataCodec.encode(args));
