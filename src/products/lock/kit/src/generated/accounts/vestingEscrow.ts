...
export const VESTING_ESCROW_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  244, 119, 183, 4, 73, 116, 135, 195,
]);

export function getVestingEscrowDiscriminatorBytes(): ReadonlyUint8Array {
...
/** Gets the encoder for {@link VestingEscrowArgs} account data. */
export function getVestingEscrowEncoder(): FixedSizeEncoder<VestingEscrowArgs> {
...
/** Gets the decoder for {@link VestingEscrow} account data. */
export function getVestingEscrowDecoder(): FixedSizeDecoder<VestingEscrow> {
...
/** Gets the codec for {@link VestingEscrow} account data. */
export function getVestingEscrowCodec(): FixedSizeCodec<
  VestingEscrowArgs,
  VestingEscrow
> {
