...
export const INSTANT_INCREASE_POSITION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([164, 126, 68, 182, 223, 166, 64, 183]);

export function getInstantIncreasePositionDiscriminatorBytes(): ReadonlyUint8Array {
