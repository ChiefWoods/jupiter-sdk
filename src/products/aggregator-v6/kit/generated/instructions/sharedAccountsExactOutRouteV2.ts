...
export const SHARED_ACCOUNTS_EXACT_OUT_ROUTE_V2_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([53, 96, 229, 202, 216, 187, 250, 24]);

export function getSharedAccountsExactOutRouteV2DiscriminatorBytes(): ReadonlyUint8Array {
