...
const FillNonFungibleCollateralOfferInstructionDataCodec = getStructCodec([
...
export async function createFillNonFungibleCollateralOfferInstruction(
    ...
    const instructionData = Buffer.from(FillNonFungibleCollateralOfferInstructionDataCodec.encode(args));
