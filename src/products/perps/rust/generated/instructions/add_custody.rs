...
pub struct AddCustody {
    ...
    pub custody_token_mint: solana_address::Address,
...
impl AddCustody {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddCustodyInstructionData::new().try_to_vec().unwrap();
...
impl AddCustodyInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct AddCustodyBuilder {
    ...
    custody_token_mint: Option<solana_address::Address>,
    ...
    doves_ag_oracle: Option<Address>,
...
impl AddCustodyBuilder {
    ...
    #[inline(always)]
    pub fn custody_token_mint(&mut self, custody_token_mint: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn doves_oracle(&mut self, doves_oracle: Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn doves_ag_oracle(&mut self, doves_ag_oracle: Address) -> &mut Self {
...
impl<'a, 'b> AddCustodyCpiBuilder<'a, 'b> {
    ...
    pub fn custody_token_mint(
        &mut self,
        custody_token_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
