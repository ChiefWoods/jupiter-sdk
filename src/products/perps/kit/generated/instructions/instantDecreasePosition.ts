...
export const INSTANT_DECREASE_POSITION_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([46, 23, 240, 44, 30, 138, 94, 140]);

export function getInstantDecreasePositionDiscriminatorBytes(): ReadonlyUint8Array {
