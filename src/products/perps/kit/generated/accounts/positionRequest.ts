...
export const POSITION_REQUEST_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([12, 38, 250, 199, 46, 154, 32, 216]);

export function getPositionRequestDiscriminatorBytes(): ReadonlyUint8Array {
...
export function decodePositionRequest<TAddress extends string = string>(
  ...
  Account<PositionRequest, TAddress> | MaybeAccount<PositionRequest, TAddress> {
