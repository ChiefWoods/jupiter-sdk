...
export const INCREASE_POSITION_PRE_SWAP_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([26, 136, 225, 217, 22, 21, 83, 20]);

export function getIncreasePositionPreSwapDiscriminatorBytes(): ReadonlyUint8Array {
...
export type IncreasePositionPreSwapInstruction<
  ...
  TAccountCollateralCustodyTokenAccount extends string | AccountMeta<string> =
    string,
  TAccountInstructionSysvar extends string | AccountMeta<string> = string,
