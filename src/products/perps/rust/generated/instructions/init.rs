...
pub struct Init {
    ...
    pub perpetuals_program: solana_address::Address,

    pub perpetuals_program_data: solana_address::Address,
...
pub struct InitBuilder {
    ...
    perpetuals_program: Option<solana_address::Address>,
    perpetuals_program_data: Option<solana_address::Address>,
...
impl InitBuilder {
    ...
    #[inline(always)]
    pub fn perpetuals_program(&mut self, perpetuals_program: solana_address::Address) -> &mut Self {
    ...
    pub fn perpetuals_program_data(
        &mut self,
        perpetuals_program_data: solana_address::Address,
    ) -> &mut Self {
...
impl<'a, 'b> InitCpiBuilder<'a, 'b> {
    ...
    pub fn perpetuals_program_data(
        &mut self,
        perpetuals_program_data: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
