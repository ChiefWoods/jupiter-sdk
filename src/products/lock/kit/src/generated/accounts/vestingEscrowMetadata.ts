...
export const VESTING_ESCROW_METADATA_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([24, 204, 166, 104, 87, 158, 76, 13]);

export function getVestingEscrowMetadataDiscriminatorBytes(): ReadonlyUint8Array {
...
/** Gets the encoder for {@link VestingEscrowMetadataArgs} account data. */
...
/** Gets the decoder for {@link VestingEscrowMetadata} account data. */
...
/** Gets the codec for {@link VestingEscrowMetadata} account data. */
