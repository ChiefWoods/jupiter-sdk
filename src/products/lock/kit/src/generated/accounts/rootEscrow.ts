...
export const ROOT_ESCROW_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  253, 209, 220, 107, 206, 191, 71, 158,
]);

export function getRootEscrowDiscriminatorBytes(): ReadonlyUint8Array {
...
/** Gets the encoder for {@link RootEscrowArgs} account data. */
export function getRootEscrowEncoder(): FixedSizeEncoder<RootEscrowArgs> {
...
/** Gets the decoder for {@link RootEscrow} account data. */
export function getRootEscrowDecoder(): FixedSizeDecoder<RootEscrow> {
...
/** Gets the codec for {@link RootEscrow} account data. */
export function getRootEscrowCodec(): FixedSizeCodec<
  RootEscrowArgs,
  RootEscrow
> {
