...
import { getBooleanCodec, getStructCodec, getU64Codec } from '@solana/codecs';
...
const SwapOutInstructionDataCodec = getStructCodec([
    ['swap0to1', getBooleanCodec()],
    ['amountOut', getU64Codec()],
    ['amountInMax', getU64Codec()],
]);
...
export function createSwapOutInstruction(
    ...
    const instructionData = Buffer.from(SwapOutInstructionDataCodec.encode(args));
