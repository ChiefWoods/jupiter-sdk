...
import { getI128Codec, getOptionCodec, getStructCodec, getU128Codec } from '@solana/codecs';
...
const RebalanceDexWithAmountsInstructionDataCodec = getStructCodec([
    ['supplyAmount', getOptionCodec(getU128Codec())],
    ['borrowAmount', getOptionCodec(getU128Codec())],
    ['colToken0MinMax', getI128Codec()],
    ['colToken1MinMax', getI128Codec()],
    ['debtToken0MinMax', getI128Codec()],
    ['debtToken1MinMax', getI128Codec()],
]);
...
export async function createRebalanceDexWithAmountsInstruction(
    ...
    const instructionData = Buffer.from(RebalanceDexWithAmountsInstructionDataCodec.encode(args));
