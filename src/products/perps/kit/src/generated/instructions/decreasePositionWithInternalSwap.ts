...
export const DECREASE_POSITION_WITH_INTERNAL_SWAP_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([131, 17, 153, 110, 119, 100, 97, 38]);

export function getDecreasePositionWithInternalSwapDiscriminatorBytes(): ReadonlyUint8Array {
