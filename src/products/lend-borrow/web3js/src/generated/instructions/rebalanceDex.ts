...
const RebalanceDexInstructionDataCodec = getStructCodec([
...
export async function createRebalanceDexInstruction(
    ...
    const instructionData = Buffer.from(RebalanceDexInstructionDataCodec.encode(args));
    const discriminator = Buffer.from('47b21392fe2f6d7e', 'hex');
