...
import { getLiquidateDexDebtAmountsEncoder, type LiquidateDexDebtAmountsArgs } from '../types/liquidateDexDebtAmounts';
...
export function createLiquidateDexInstruction(
    ...
    const instructionData = Buffer.from(getLiquidateDexInstructionDataEncoder().encode(args));
