...
export const CREATE_ROOT_ESCROW_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([116, 212, 12, 188, 77, 226, 32, 201]);

export function getCreateRootEscrowDiscriminatorBytes(): ReadonlyUint8Array {
...
export function getCreateRootEscrowInstructionDataEncoder(): FixedSizeEncoder<CreateRootEscrowInstructionDataArgs> {
...
export function getCreateRootEscrowInstructionDataDecoder(): FixedSizeDecoder<CreateRootEscrowInstructionData> {
...
export function getCreateRootEscrowInstructionDataCodec(): FixedSizeCodec<
