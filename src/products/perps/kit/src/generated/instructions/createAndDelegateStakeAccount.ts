...
export const CREATE_AND_DELEGATE_STAKE_ACCOUNT_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([98, 209, 122, 27, 222, 137, 94, 134]);

export function getCreateAndDelegateStakeAccountDiscriminatorBytes(): ReadonlyUint8Array {
