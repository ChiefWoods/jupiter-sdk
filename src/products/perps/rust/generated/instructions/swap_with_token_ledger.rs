...
pub struct SwapWithTokenLedger {
    ...
    pub token_ledger: solana_address::Address,
...
impl SwapWithTokenLedger {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SwapWithTokenLedgerInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl SwapWithTokenLedgerInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
impl SwapWithTokenLedgerBuilder {
    ...
    #[inline(always)]
    pub fn token_ledger(&mut self, token_ledger: solana_address::Address) -> &mut Self {
