...
const UpdateOracleInstructionDataCodec = getStructCodec([['vaultId', getU16Codec()]]);
...
export function createUpdateOracleInstruction(
    ...
    const instructionData = Buffer.from(UpdateOracleInstructionDataCodec.encode(args));
