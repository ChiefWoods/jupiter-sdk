...
import { getI128Encoder, getStructEncoder, type Encoder } from '@solana/codecs';
...
export async function createRebalanceDexInstruction(
    ...
    const instructionData = Buffer.from(getRebalanceDexInstructionDataEncoder().encode(args));
