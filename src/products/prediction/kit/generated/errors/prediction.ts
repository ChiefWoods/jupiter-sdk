...
let predictionErrorMessages: Record<PredictionError, string> | undefined;
if (process.env["NODE_ENV"] !== "production") {
  predictionErrorMessages = {
    [PREDICTION_ERROR__CLAIMS_NOT_ENABLED]: `Claims not enabled`,
    [PREDICTION_ERROR__CONTRACTS_BELOW_MINIMUM]: `Contracts below minimum`,
    [PREDICTION_ERROR__DEPOSIT_BELOW_MINIMUM]: `Deposit amount must be at least $1`,
    [PREDICTION_ERROR__DEPOSIT_NOT_ALLOWED_FOR_SELLS]: `Deposit not allowed for sell orders`,
    [PREDICTION_ERROR__DEPOSITS_DISABLED]: `Deposits disabled`,
    [PREDICTION_ERROR__EVENT_ALREADY_CANCELLED]: `Event already cancelled`,
    [PREDICTION_ERROR__EVENT_ALREADY_EXISTS]: `Event already exists`,
    [PREDICTION_ERROR__EVENT_ALREADY_EXPIRED]: `Event already expired`,
    [PREDICTION_ERROR__EVENT_ALREADY_RESOLVED]: `Event already resolved`,
    [PREDICTION_ERROR__EVENT_CREATION_DISABLED]: `Event creation disabled`,
    [PREDICTION_ERROR__EXCEEDS_GLOBAL_LIMIT]: `Exceeds global limit`,
    [PREDICTION_ERROR__FILL_PRICE_EXCEEDS_LIMIT]: `Fill price exceeds user's limit`,
    [PREDICTION_ERROR__GLOBAL_MAX_CONTRACTS_EXCEEDED]: `Global max contracts limit exceeded`,
    [PREDICTION_ERROR__INSUFFICIENT_CONTRACTS]: `Insufficient contracts`,
    [PREDICTION_ERROR__INSUFFICIENT_FUNDS]: `Insufficient funds`,
    [PREDICTION_ERROR__INSUFFICIENT_VAULT_BALANCE]: `Insufficient vault balance`,
    [PREDICTION_ERROR__INSUFFICIENT_VAULT_FUNDS]: `Insufficient vault funds`,
    [PREDICTION_ERROR__INVALID_ADMIN]: `Invalid admin`,
    [PREDICTION_ERROR__INVALID_A_P_I_AUTHORITY]: `Invalid API authority`,
    [PREDICTION_ERROR__INVALID_ARGUMENT]: `Invalid argument`,
    [PREDICTION_ERROR__INVALID_CLOSE_TIME]: `Invalid close time`,
    [PREDICTION_ERROR__INVALID_CONTRACT_UNIT_VERSION]: `Invalid contract unit version`,
    [PREDICTION_ERROR__INVALID_DEFAULTS]: `Invalid defaults`,
    [PREDICTION_ERROR__INVALID_DEPOSIT_AMOUNT]: `Invalid deposit amount`,
    [PREDICTION_ERROR__INVALID_EVENT]: `Invalid event`,
    [PREDICTION_ERROR__INVALID_EVENT_UPDATE]: `Invalid event update - event is finalized or immutable`,
    [PREDICTION_ERROR__INVALID_EXPIRY_TIME]: `Invalid expiry time`,
    [PREDICTION_ERROR__INVALID_FEE]: `Invalid fee`,
    [PREDICTION_ERROR__INVALID_FILL]: `Invalid fill data - contracts or price is zero`,
    [PREDICTION_ERROR__INVALID_FILL_PRICE]: `Invalid fill price`,
    [PREDICTION_ERROR__INVALID_INTEGRATOR_FEE]: `Invalid integrator fee`,
    [PREDICTION_ERROR__INVALID_INTEGRATOR_TOKEN_ACCOUNT]: `Invalid integrator token account`,
    [PREDICTION_ERROR__INVALID_KEEPER]: `Invalid keeper`,
    [PREDICTION_ERROR__INVALID_MARKET_RESULT]: `Invalid market result`,
    [PREDICTION_ERROR__INVALID_MARKET_STATUS]: `Invalid market status`,
    [PREDICTION_ERROR__INVALID_MAX_CONTRACTS]: `Invalid max contracts`,
    [PREDICTION_ERROR__INVALID_MAX_OPEN_ORDERS]: `Invalid max open orders`,
    [PREDICTION_ERROR__INVALID_MINT]: `Invalid mint`,
    [PREDICTION_ERROR__INVALID_OPEN_TIME]: `Invalid open time`,
    [PREDICTION_ERROR__INVALID_ORDER]: `Invalid order`,
    [PREDICTION_ERROR__INVALID_OWNER]: `Invalid owner`,
    [PREDICTION_ERROR__INVALID_POSITION]: `Invalid argument`,
    [PREDICTION_ERROR__INVALID_POSITION_OWNER]: `Position owner mismatch`,
    [PREDICTION_ERROR__INVALID_SETTLEMENT_TIME]: `Invalid settlement time`,
    [PREDICTION_ERROR__INVALID_STATUS_TRANSITION]: `Invalid status transition`,
    [PREDICTION_ERROR__INVALID_TICKET]: `Invalid ticket`,
    [PREDICTION_ERROR__INVALID_TOKEN_ACCOUNT]: `Invalid token account owner`,
    [PREDICTION_ERROR__INVALID_VAULT_CONFIG]: `Invalid vault config`,
    [PREDICTION_ERROR__MARKET_ALREADY_SETTLED]: `Market already settled`,
    [PREDICTION_ERROR__MARKET_CREATION_DISABLED]: `Market creation disabled`,
    [PREDICTION_ERROR__MARKET_NOT_CLOSED]: `Market not closed`,
    [PREDICTION_ERROR__MARKET_NOT_OPEN]: `Market not open`,
    [PREDICTION_ERROR__MARKET_NOT_RESOLVED]: `Market not resolved`,
    [PREDICTION_ERROR__MARKET_NOT_SETTLED]: `Market not settled`,
    [PREDICTION_ERROR__MARKET_STILL_OPEN]: `Market still open (before close time)`,
    [PREDICTION_ERROR__MATH_OVERFLOW]: `Math overflow`,
    [PREDICTION_ERROR__MAX_EVENTS_EXCEEDED]: `Max events exceeded`,
    [PREDICTION_ERROR__MIGRATION_STATE_MISMATCH]: `Migration state mismatch - account may already be migrated`,
    [PREDICTION_ERROR__MISSING_FILL_DATA]: `Missing fill data`,
    [PREDICTION_ERROR__ORDER_NOT_FAILED]: `Order is not failed`,
    [PREDICTION_ERROR__PARTIAL_FILL_NOT_ALLOWED]: `Partial fills not allowed (FOK orders only)`,
    [PREDICTION_ERROR__PAYOUT_ALREADY_CLAIMED]: `Payout already claimed`,
    [PREDICTION_ERROR__POSITION_MAX_CONTRACTS_EXCEEDED]: `Position max contracts limit exceeded`,
    [PREDICTION_ERROR__POSITION_NOT_CLOSABLE]: `Position cannot be closed - has active contracts or open orders`,
    [PREDICTION_ERROR__POSITION_OPENED_AFTER_SETTLEMENT]: `Position opened after settlement time`,
    [PREDICTION_ERROR__SETTLEMENT_DELAY_NOT_PASSED]: `Settlement delay not passed`,
    [PREDICTION_ERROR__TICKET_NOT_CLAIMABLE]: `Ticket is not claimable yet`,
    [PREDICTION_ERROR__TICKET_REFUND_WINDOW_EXPIRED]: `Ticket refund window expired`,
    [PREDICTION_ERROR__TOO_MANY_OPEN_ORDERS]: `Too many open orders`,
    [PREDICTION_ERROR__TRADING_DISABLED]: `Trading disabled`,
    [PREDICTION_ERROR__WITHDRAWALS_DISABLED]: `Withdrawals disabled`,
  };
}

export function getPredictionErrorMessage(code: PredictionError): string {
  if (process.env["NODE_ENV"] !== "production") {
    return (predictionErrorMessages as Record<PredictionError, string>)[code];
  }

  return "Error message not available in production bundles.";
}

export function isPredictionError<TProgramErrorCode extends PredictionError>(
  error: unknown,
  transactionMessage: {
