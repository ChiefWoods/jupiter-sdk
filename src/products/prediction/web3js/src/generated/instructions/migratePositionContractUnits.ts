...
const MigratePositionContractUnitsInstructionDataCodec = getStructCodec([['expectedContracts', getU64Codec()]]);
...
export function createMigratePositionContractUnitsInstruction(
    ...
    const instructionData = Buffer.from(MigratePositionContractUnitsInstructionDataCodec.encode(args));
