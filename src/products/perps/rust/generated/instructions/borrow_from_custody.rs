...
pub struct BorrowFromCustody {
    ...
    pub borrow_position: solana_address::Address,
...
impl BorrowFromCustody {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BorrowFromCustodyInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl BorrowFromCustodyInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct BorrowFromCustodyBuilder {
    ...
    borrow_position: Option<solana_address::Address>,
...
impl BorrowFromCustodyBuilder {
    ...
    #[inline(always)]
    pub fn borrow_position(&mut self, borrow_position: solana_address::Address) -> &mut Self {
...
impl<'a, 'b> BorrowFromCustodyCpiBuilder<'a, 'b> {
    ...
    pub fn borrow_position(
        &mut self,
        borrow_position: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
