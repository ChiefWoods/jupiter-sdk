...
import { getStructCodec, getU16Codec, getU32Codec } from '@solana/codecs';
...
const InitPositionInstructionDataCodec = getStructCodec([
    ['vaultId', getU16Codec()],
...
export async function createInitPositionInstruction(
    ...
    const instructionData = Buffer.from(InitPositionInstructionDataCodec.encode(args));
