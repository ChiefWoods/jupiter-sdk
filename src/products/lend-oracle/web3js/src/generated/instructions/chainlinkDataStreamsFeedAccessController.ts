...
const ChainlinkDataStreamsFeedAccessControllerInstructionDataCodec = getStructCodec([['suspend', getBooleanCodec()]]);
...
export function createChainlinkDataStreamsFeedAccessControllerInstruction(
    ...
    const instructionData = Buffer.from(ChainlinkDataStreamsFeedAccessControllerInstructionDataCodec.encode(args));
