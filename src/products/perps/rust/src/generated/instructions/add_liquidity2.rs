...
pub struct AddLiquidity2 {
    ...
    pub lp_token_account: solana_address::Address,
...
impl AddLiquidity2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddLiquidity2InstructionData::new().try_to_vec().unwrap();
...
impl AddLiquidity2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct AddLiquidity2Builder {
    ...
    lp_token_account: Option<solana_address::Address>,
...
impl AddLiquidity2Builder {
    ...
    #[inline(always)]
    pub fn lp_token_account(&mut self, lp_token_account: solana_address::Address) -> &mut Self {
...
impl<'a, 'b> AddLiquidity2CpiBuilder<'a, 'b> {
    ...
    pub fn lp_token_account(
        &mut self,
        lp_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
