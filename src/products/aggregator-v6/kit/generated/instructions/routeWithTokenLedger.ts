...
export const ROUTE_WITH_TOKEN_LEDGER_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([150, 86, 71, 116, 167, 93, 14, 104]);

export function getRouteWithTokenLedgerDiscriminatorBytes(): ReadonlyUint8Array {
...
export function getRouteWithTokenLedgerInstructionDataCodec(): Codec<
...
export type RouteWithTokenLedgerInput<
...
> {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta("userSourceTokenAccount", accounts.userSourceTokenAccount),
      getAccountMeta(
        "userDestinationTokenAccount",
        accounts.userDestinationTokenAccount,
      ),
      getAccountMeta(
        "destinationTokenAccount",
...
> = {
  ...
  accounts: {
    ...
    tokenLedger: TAccountMetas[7];
    eventAuthority: TAccountMetas[8];
    program: TAccountMetas[9];
  };
  data: RouteWithTokenLedgerInstructionData;
};
