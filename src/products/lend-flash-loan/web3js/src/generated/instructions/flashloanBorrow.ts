...
const FlashloanBorrowInstructionDataCodec = getStructCodec([['amount', getU64Codec()]]);
...
export function createFlashloanBorrowInstruction(
    ...
    const instructionData = Buffer.from(FlashloanBorrowInstructionDataCodec.encode(args));
