...
export function swap(
  kind: "Obsidian",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "Obsidian">;
export function swap(
  kind: "WhaleStreet",
...
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "PumpWrappedBuyV4">;
export function swap(
  kind: "PumpWrappedSellV4",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "PumpWrappedSellV4">;
export function swap(
  kind: "CarrotIssue",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "CarrotIssue">;
export function swap(
  kind: "CarrotRedeem",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "CarrotRedeem">;
export function swap(
  kind: "Manifest",
...
export function swap(
  kind: "XOrca",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "XOrca">;
export function swap(
  kind: "Quantum",
...
export function swap(
  kind: "RunnerRodeo",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "RunnerRodeo">;
export function swap(
  kind: "TaurusFi",
...
export function swap(
  kind: "Omnipair",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "Omnipair">;
export function swap(
  kind: "MSwap",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "MSwap">;
export function swap(
  kind: "Hylo",
...
export function swap(
  kind: "VoltrDeposit",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "VoltrDeposit">;
export function swap(
  kind: "VoltrWithdraw",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "VoltrWithdraw">;
export function swap(
  kind: "SanctumSV2",
...
export function swap(
  kind: "ScaleVmmBuy",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "ScaleVmmBuy">;
export function swap(
  kind: "ScaleVmmSell",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "ScaleVmmSell">;
export function swap(
  kind: "ScaleAmmBuy",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "ScaleAmmBuy">;
export function swap(
  kind: "ScaleAmmSell",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "ScaleAmmSell">;
export function swap(
  kind: "BisonFiV2",
...
export function swap(
  kind: "Trends",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "Trends">;
export function swap(
  kind: "HumaDeposit",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "HumaDeposit">;
export function swap(
...
export function swap(
  kind: "ZeroFiSwapV2",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "ZeroFiSwapV2">;
export function swap(
  kind: "BisonFiPredict",
  data: GetDiscriminatedUnionVariantContent<
    SwapArgs,
...
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "ByrealDynamicV3">;
export function swap(
  kind: "Flux",
...
export function swap(
  kind: "BinaryFi",
): GetDiscriminatedUnionVariant<SwapArgs, "__kind", "BinaryFi">;
export function swap(
  kind: "Metric",
