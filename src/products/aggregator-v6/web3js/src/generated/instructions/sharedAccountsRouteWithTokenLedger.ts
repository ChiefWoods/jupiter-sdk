...
export interface SharedAccountsRouteWithTokenLedgerInstructionArgs {
    id: number;
...
function getSharedAccountsRouteWithTokenLedgerInstructionDataEncoder(): Encoder<SharedAccountsRouteWithTokenLedgerInstructionArgs> {
