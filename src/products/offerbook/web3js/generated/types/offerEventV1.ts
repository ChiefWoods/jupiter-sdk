...
export function getOfferEventV1Encoder(): Encoder<OfferEventV1Args> {
...
export function getOfferEventV1Decoder(): Decoder<OfferEventV1> {
...
export function getOfferEventV1Codec(): Codec<OfferEventV1Args, OfferEventV1> {
    return combineCodec(getOfferEventV1Encoder(), getOfferEventV1Decoder());
}
