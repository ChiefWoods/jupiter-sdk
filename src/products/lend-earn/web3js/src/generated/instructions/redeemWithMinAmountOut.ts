...
const RedeemWithMinAmountOutInstructionDataCodec = getStructCodec([
    ['shares', getU64Codec()],
...
export function createRedeemWithMinAmountOutInstruction(
    ...
    const instructionData = Buffer.from(RedeemWithMinAmountOutInstructionDataCodec.encode(args));
