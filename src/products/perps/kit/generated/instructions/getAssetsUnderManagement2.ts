...
export const GET_ASSETS_UNDER_MANAGEMENT2_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([193, 210, 13, 249, 113, 149, 29, 84]);

export function getGetAssetsUnderManagement2DiscriminatorBytes(): ReadonlyUint8Array {
